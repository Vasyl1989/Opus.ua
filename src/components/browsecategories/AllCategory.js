        ...
        <div className="container">
          <div className="sixteen columns">
            <ul id="popular-categories">
              ...
              <li>
                <a href=""
                  data-name="Виробництво"
                  onClick={(e) => { this.onSearchInput(e, this.state.city); }}>
                  <i className="ln  ln-icon-Factory" />
                  Виробництво</a>
              </li>
              <li>
                <a href=""
                  data-name="ІТ"
                  onClick={(e) => { this.onSearchInput(e, this.state.city); }}>
                  <i className="ln ln-icon-Computer-2" />
                  ІТ</a>
              </li>
              <li>
                <a href=""
                  data-name=" Краса та здоров'я"
                  onClick={(e) => { this.onSearchInput(e, this.state.city); }}>
                  <i className="ln ln-icon-Gemini-2" />
                  Краса та здоров'я</a>
              </li>
              <li>
                <a href=""
              ...
              <li>
                <a href=""
                  ...
                  Навчання та репетиторство</a>
              </li>
              <li>
                <a href=""
                  data-name="Робочі спеціальності"
                  onClick={(e) => { this.onSearchInput(e, this.state.city); }}>
                  <i className="ln ln-icon-Gear-2" />
                  Робочі спеціальності</a>
              </li>
              <li>
                <a href=""
                  data-name="Сільськогосподарські роботи"
                  onClick={(e) => { this.onSearchInput(e, this.state.city); }}>
                  <i className="ln  ln-icon-Farmer" />
                  Сільськогосподарські роботи</a>
              </li>
              <li>
                <a href=""
                  ...
                  Сфера обслуговування</a>
              </li>
              <li>
                <a href=""
                  data-name="Телекомунікація"
                  onClick={(e) => { this.onSearchInput(e, this.state.city); }}>
              ...
              <li><a href=""
                ...
                onClick={(e) => { this.onSearchInput(e, this.state.city); }}>
                <i className="ln  ln-icon-People-onCloud" />
                Управління персоналом</a>
              </li>
            </ul>
